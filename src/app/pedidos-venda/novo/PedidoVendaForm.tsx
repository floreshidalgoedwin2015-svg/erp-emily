...
import { criarPedidoVenda } from "./actions";
...
export function PedidoVendaForm({ produtos }: { produtos: ProdutoOpcao[] }) {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              placeholder="Instruções especiais, prazo de entrega..."
              className={inp}
            />
          </div>
        </div>
      ...
      <div className="flex gap-3 justify-end pb-8">
        <a href="/pedidos-venda" className="px-5 py-2.5 rounded-xl border border-zinc-200 text-sm font-medium text-zinc-600 hover:bg-zinc-50 transition">Cancelar</a>
